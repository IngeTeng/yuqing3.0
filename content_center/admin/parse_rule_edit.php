            ...
            $(function(){
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $('input[name="url"]').val(data['site_url']);
                        $('input[name="click_b"]').val(data['click_b']);
                        $('input[name="click_e"]').val(data['click_e']);
                        $('input[name="title_b"]').val(data['title_b']);
                        $('input[name="title_e"]').val(data['title_e']);
                        $('input[name="author_b"]').val(data['author_b']);
                        $('input[name="author_e"]').val(data['author_e']);
                        $('input[name="pubtime_b"]').val(data['time_b']);
                        $('input[name="pubtime_e"]').val(data['time_e']);
                        $('input[name="media_b"]').val(data['media_b']);
                        $('input[name="media_e"]').val(data['media_e']);
                        $('input[name="content_b"]').val(data['content_b']);
                        $('input[name="content_e"]').val(data['content_e']);
                        $('input[name="channel_b"]').val(data['channel_b']);
                        $('input[name="channel_e"]').val(data['channel_e']);
                        $('input[name="comment_b"]').val(data['comment_b']);
                        $('input[name="comment_e"]').val(data['comment_e']);
                        $('input[name="is_repost"]').val(data['is_repost']);
                    }
                });
                //添加过滤规则
