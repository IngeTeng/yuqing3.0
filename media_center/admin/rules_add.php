                            ...
                            switch(code){
                                case 1:
                                    layer.alert(msg, {icon: 6,shade: false}, function(index){
                                        parent.location.href = 'rules_list.php?id=<?php echo $siteId?>&type=<?php echo $type?>';
                                    });
                                    break;
                                default:
        ...
        <div id="container">
            <div id="maincontent">
                <div id="formlist">
                    ...
                    <p>
                        <label>示例网址</label>
                        <input name="example_site" type="text" class="text-input input-length-50" />
