    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#addinterface').click(function () {
                location.href = 'serverOut_add.php';
            });
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="handlelist">
            <?php
            //初始化
            $totalcount= InterfaceIn::searchByTypeCount($params,1);
            $shownum   = 10;
            ...
            $rows      = InterfaceIn::searchByType($params,1);
            ?>
            <div class="btns">
                ...
                if(!empty($rows)){
                    foreach($rows as $row){
                        ...
                        echo '<tr>
											...
											<td class="center">
											<a class="editinfo" href="serverOut_edit.php?id='.$row['id'].'"><img src="images/action/dot_edit.png"/></a> 
